...
latex_documents = [
    (master_doc, "ermsfkit.tex", "eRMSF Documentation",
     "ermsfkit", "manual"),
]
...
man_pages = [
    (master_doc, "ermsfkit", "eRMSF Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "ermsfkit", "eRMSF Documentation",
     author, "ermsfkit", "eRMSF: A Python Package for Ensemble RMSF Analysis of Molecular Dynamics and Structural Ensembles",
     "Miscellaneous"),
]
